...
var rotate$1 = styled.keyframes(templateObject_1$1g || (templateObject_1$1g = __makeTemplateObject(["\n  from {\n    transform: rotate(0deg);\n  }\n  to {\n    transform: rotate(360deg);\n  }\n"], ["\n  from {\n    transform: rotate(0deg);\n  }\n  to {\n    transform: rotate(360deg);\n  }\n"])));
...
var templateObject_1$1g, templateObject_2$x, templateObject_3$f;
...
var TooltipText = styled__default['default'](Text)(templateObject_1$1e || (templateObject_1$1e = __makeTemplateObject(["\n  text-decoration: ", ";\n  text-underline-offset: 0.1em;\n"], ["\n  text-decoration: ", ";\n  text-underline-offset: 0.1em;\n"])), function (_a) {
    var theme = _a.theme;
...
var Icon$1j = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ width: "40", height: "39", viewBox: "0 0 40 39", fill: "none", xmlns: "http://www.w3.org/2000/svg" }, props),
        React__default['default'].createElement("path", { d: "M31.553 3.58228C39.7517 9.33835 41.3195 21.243 35.1671 29.0902C29.1494 37.039 17.2311 38.5561 9.58105 32.0913C17.3209 37.7536 28.6964 36.2443 34.4759 28.5572C40.4409 20.952 39.0097 9.67029 31.553 3.58228Z", fill: "#C89211" }),
        React__default['default'].createElement("path", { d: "M2.26097 23.4981C-0.34176 15.6567 3.63946 6.42314 10.7662 2.39896C13.1229 1.03219 15.7803 0.204311 18.4397 0.0891113C15.917 0.922845 13.5779 2.05922 11.5121 3.55486C5.15463 8.0496 1.79236 15.7504 2.26097 23.4981Z", fill: "#4A8B2C" }),
        React__default['default'].createElement("path", { d: "M35.5833 15.9143C35.7297 22.2308 31.684 28.3324 25.8284 30.7165C16.6495 34.6626 5.78755 28.8713 3.95998 19.0442C1.93129 9.29912 9.73948 -0.178493 19.6974 0.0284754C16.5851 0.0675261 13.4903 1.01451 10.9188 2.77569C2.73964 8.24866 1.57593 20.1064 8.58749 27.0242C18.6001 36.8963 35.3451 29.9355 35.5833 15.9143Z", fill: "#6BA43A" }),
        React__default['default'].createElement("path", { d: "M36.8697 13.05C38.752 18.9545 37.1353 25.8118 32.8807 30.3319C20.7379 43.1034 -0.388581 33.1806 1.65182 15.6918C2.50313 8.5943 7.93899 2.36375 14.8881 0.688477C8.15572 2.70154 3.05374 8.7876 2.32935 15.7738C1.23593 25.638 8.56575 34.5006 18.471 35.2308C30.5884 36.088 39.8493 24.7847 36.8697 13.05Z", fill: "#4A8B2C" }),
        React__default['default'].createElement("path", { d: "M38.9982 17.5682C39.3673 23.7695 36.0616 29.8887 30.7995 33.1534C26.2365 36.0529 20.3554 36.6855 15.2632 34.8833C4.34852 31.0407 -0.275087 18.0563 5.8715 8.22532C9.13614 2.96323 15.2554 -0.344365 21.4586 0.0285696C15.4877 0.323403 9.90739 3.66224 6.9532 8.87551C1.24203 18.853 6.91806 31.6226 18.1959 33.9617C28.6986 36.1525 38.4828 28.2076 38.9982 17.5682Z", fill: "#00783F" }),
        React__default['default'].createElement("path", { d: "M35.4173 9.60574C38.434 15.6742 37.364 23.3145 32.8029 28.3306C22.5638 39.6182 3.88578 32.9874 3.054 17.7712C2.73574 11.8883 5.7075 6.00526 10.6513 2.80505C11.3484 2.34621 12.0806 1.94984 12.8304 1.58862C11.3406 2.32473 9.94841 3.25999 8.73003 4.39247C3.09891 9.55302 1.65794 18.1422 5.32676 24.8433C10.7704 35.0141 24.8814 36.7187 32.6037 28.1509C37.1453 23.2598 38.2953 15.6293 35.4173 9.60574Z", fill: "#6BA43A" }),
        React__default['default'].createElement("path", { d: "M31.5528 3.58228C37.3264 7.89152 39.978 15.6138 38.0703 22.5668C33.8001 38.1676 12.9431 40.866 4.84207 26.8682C1.71216 21.4558 1.69654 14.4579 4.83426 9.05133C5.27358 8.28203 5.77538 7.55374 6.31038 6.85082C5.2521 8.26446 4.38323 9.81868 3.77403 11.4764C0.921379 19.0854 3.67836 27.8894 10.3814 32.4857C20.4292 39.505 34.6202 34.3308 37.8126 22.4985C39.7573 15.6685 37.1839 7.913 31.5528 3.58228Z", fill: "#4A8B2C" }),
        React__default['default'].createElement("path", { d: "
7149 25.6146 25.1311 25.4096V21.9985H20.9508V20.3252C23.7819 18.6851 27.1793 18.4293 30.1843 19.4993C30.2839 19.841 30.5982 20.0889 30.9692 20.0889C31.4242 20.0889 31.7912 19.7218 31.7912 19.2669C31.7912 18.8139 31.4242 18.4468 30.9692 18.4468C30.8443 18.4468 30.7252 18.4742 30.6197 18.5249C29.4892 18.1091 28.2982 17.863 27.0739 17.8045C27.5269 17.4491 27.9526 17.0644 28.3548 16.6564C28.6086 16.6876 28.8663 16.7071 29.1241 16.7071ZM17.1726 26.8232C17.1726 27.3524 16.743 27.7819 16.2139 27.7819C15.6848 27.7819 15.2552 27.3504 15.2552 26.8232C15.2552 26.2941 15.6848 25.8645 16.2139 25.8645C16.743 25.8645 17.1726 26.296 17.1726 26.8232ZM21.3608 27.8815C21.3608 28.4106 20.9312 28.8402 20.4021 28.8402C19.873 28.8402 19.4434 28.4087 19.4434 27.8815C19.4434 27.3973 19.8027 26.999 20.2674 26.9326H20.5349C21.0015 26.997 21.3608 27.3973 21.3608 27.8815ZM25.588 26.8232C25.588 27.3524 25.1585 27.7819 24.6293 27.7819C24.1002 27.7819 23.6706 27.3504 23.6706 26.8232C23.6706 26.2941 24.1002 25.8645 24.6293 25.8645C25.1585 25.8645 25.588 26.296 25.588 26.8232Z", fill: "#FFFFFF" })));
};
...
var Icon$H = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 80 80" }, props),
        ...
        React__default['default'].createElement("path", { opacity: "0.4", d:"M8.3 11.7v-.925c0-.358-.267-.533-.592-.391l-4.175 1.8c-.658.283-1.191-.067-1.191-.775v-1.1c0-.567.425-1.225.95-1.442l4.75-2.042a.487.487 0 0 0 .25-.391v-2.55c0-.8.591-1.759 1.3-2.125a.9.9 0 0 1 .8 0c.716.366 1.308 1.316 1.308 2.116v2.55c0 .15.117.325.25.392l.867.367L8.3 11.7Z", fill: "#DBCDF9" }),
        
        React__default['default'].createElement("path", { d:"M17.659 10.309v1.1c0 .708-.534 1.058-1.192.775l-4.175-1.8c-.333-.134-.592.033-.592.391V13.2c0 .192.109.467.25.6l1.934 1.942c.2.2.291.6.2.875l-.375 1.133a.852.852 0 0 1-1.184.492l-1.983-1.667a.866.866 0 0 0-1.092 0l-1.983 1.667A.826.826 0 0 1 6.3 17.75l-.375-1.133c-.091-.283 0-.675.2-.875L8.06 13.8a.986.986 0 0 0 .241-.6v-1.5l4.517-4.516 3.892 1.675c.525.225.95.883.95 1.45Z", fill: "#DBCDF9" }),
...
var Icon$r = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 24 24" }, props),
        React__default['default'].createElement("path", { opacity: "0.4", d: "M18.04 13.55C17.62 13.96 17.38 14.55 17.44 15.18C17.53 16.26 18.52 17.05 19.6 17.05H21.5V18.24C21.5 20.31 19.81 22 17.74 22H6.26C4.19 22 2.5 20.31 2.5 18.24V11.51C2.5 9.44001 4.19 7.75 6.26 7.75H17.74C19.81 7.75 21.5 9.44001 21.5 11.51V12.95H19.48C18.92 12.95 18.41 13.17 18.04 13.55Z" }),
        React__default['default'].createElement("path", { d: "M14.85 3.95012V7.75011H6.26C4.19 7.75011 2.5 9.44012 2.5 11.5101V7.84014C2.5 6.65014 3.23 5.59009 4.34 5.17009L12.28 2.17009C13.52 1.71009 14.85 2.62012 14.85 3.95012Z" }),
        React__default['default'].createElement("path", { d: "M22.5608 13.9702V16.0302C22.5608 16.5802 22.1208 17.0302 21.5608 17.0502H19.6008C18.5208 17.0502 17.5308 16.2602 17.4408 15.1802C17.3808 14.5502 17.6208 13.9602 18.0408 13.5502C18.4108 13.1702 18.9208 12.9502 19.4808 12.9502H21.5608C22.1208 12.9702 22.5608 13.4202 22.5608 13.9702Z" }),
        React__default['default'].createElement("path", { d: "M14 12.75H7C6.59 12.75 6.25 12.41 6.25 12C6.25 11.59 6.59 11.25 7 11.25H14C14.41 11.25 14.75 11.59 14.75 12C14.75 12.41 14.41 12.75 14 12.75Z" })));
};
...
var Icon$o = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 24 24" }, props),
        React__default['default'].createElement("path", { opacity: "0.4", d: "M10.7702 8.52002L15.8202 12.31V17.92C15.8202 18.88 14.6602 19.36 13.9802 18.68L8.80023 13.51C7.97023 12.68 7.97023 11.33 8.80023 10.5L10.7702 8.52002Z" }),
        React__default['default'].createElement("path", { d: "M15.8195 6.07993V12.3099L10.7695 8.51993L13.9795 5.30993C14.6595 4.63993 15.8195 5.11993 15.8195 6.07993Z" })));
};

var Icon$n = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 24 24" }, props),
        React__default['default'].createElement("path", { d: "M15 15.5C15 19.09 12.09 22 8.5 22C4.91 22 2 19.09 2 15.5C2 11.91 4.91 9 8.5 9C8.67 9 8.84999 9.01 9.01999 9.02C12.19 9.27 14.73 11.81 14.98 14.98C14.99 15.15 15 15.33 15 15.5Z" }),
        React__default['default'].createElement("path", { opacity: "0.4", d: "M22 8.5C22 12.09 19.09 15 15.5 15C15.33 15 15.15 14.99 14.98 14.98C14.73 11.81 12.19 9.27 9.01999 9.02C9.00999 8.85 9 8.67 9 8.5C9 4.91 11.91 2 15.5 2C19.09 2 22 4.91 22 8.5Z" }),
        React__default['default'].createElement("path", { d: "M5.59 2H3C2.45 2 2 2.45 2 3V5.59C2 6.48 3.07999 6.93 3.70999 6.3L6.29999 3.71001C6.91999 3.08001 6.48 2 5.59 2Z" }),
        React__default['default'].createElement("path", { d: "M18.4097 22H20.9997C21.5497 22 21.9997 21.55 21.9997 21V18.41C21.9997 17.52 20.9197 17.07 20.2897 17.7L17.6997 20.29C17.0797 20.92 17.5197 22 18.4097 22Z" })));
};

var Icon$m = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 24 24" }, props),
        React__default['default'].createElement("path", { opacity: "0.4", d: "M22 8.52V3.98C22 2.57 21.36 2 19.77 2H15.73C14.14 2 13.5 2.57 13.5 3.98V8.51C13.5 9.93 14.14 10.49 15.73 10.49H19.77C21.36 10.5 22 9.93 22 8.52Z" }),
        React__default['default'].createElement("path", { d: "M22 19.77V15.73C22 14.14 21.36 13.5 19.77 13.5H15.73C14.14 13.5 13.5 14.14 13.5 15.73V19.77C13.5 21.36 14.14 22 15.73 22H19.77C21.36 22 22 21.36 22 19.77Z" }),
        React__default['default'].createElement("path", { d: "M10.5 8.52V3.98C10.5 2.57 9.86 2 8.27 2H4.23C2.64 2 2 2.57 2 3.98V8.51C2 9.93 2.64 10.49 4.23 10.49H8.27C9.86 10.5 10.5 9.93 10.5 8.52Z" }),
        React__default['default'].createElement("path", { opacity: "0.4", d: "M10.5 19.77V15.73C10.5 14.14 9.86 13.5 8.27 13.5H4.23C2.64 13.5 2 14.14 2 15.73V19.77C2 21.36 2.64 22 4.23 22H8.27C9.86 22 10.5 21.36 10.5 19.77Z" })));
};

var Icon$l = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 24 24" }, props),
        React__default['default'].createElement("path", { d: "M18.75 8V10.1C18.31 10.04 17.81 10.01 17.25 10V8C17.25 4.85 16.36 2.75 12 2.75C7.64 2.75 6.75 4.85 6.75 8V10C6.19 10.01 5.69 10.04 5.25 10.1V8C5.25 5.1 5.95 1.25 12 1.25C18.05 1.25 18.75 5.1 18.75 8Z" }),
        React__default['default'].createElement("path", { opacity: "0.4", d: "M22 15V17C22 21 21 22 17 22H7C3 22 2 21 2 17V15C2 11.66 2.7 10.41 5.25 10.1C5.69 10.04 6.19 10.01 6.75 10H17.25C17.81 10.01 18.31 10.04 18.75 10.1C21.3 10.41 22 11.66 22 15Z" }),
        React__default['default'].createElement("path", { d: "M8 17.0001C7.87 17.0001 7.74 16.9701 7.62 16.9201C7.49 16.8701 7.39001 16.8001 7.29001 16.7101C7.11001 16.5201 7 16.2601 7 16.0001C7 15.8701 7.02999 15.7401 7.07999 15.6201C7.12999 15.5001 7.20001 15.3901 7.29001 15.2901C7.39001 15.2001 7.49 15.1301 7.62 15.0801C7.99 14.9201 8.42999 15.0101 8.70999 15.2901C8.79999 15.3901 8.87001 15.5001 8.92001 15.6201C8.97001 15.7401 9 15.8701 9 16.0001C9 16.2601 8.88999 16.5201 8.70999 16.7101C8.51999 16.8901 8.26 17.0001 8 17.0001Z" }),
        React__default['default'].createElement("path", { d: "M12 17C11.73 17 11.48 16.89 11.29 16.71C11.2 16.61 11.13 16.5 11.08 16.38C11.03 16.26 11 16.13 11 16C11 15.73 11.11 15.48 11.29 15.29C11.66 14.92 12.33 14.92 12.71 15.29C12.89 15.48 13 15.73 13 16C13 16.13 12.97 16.26 12.92 16.38C12.87 16.5 12.8 16.61 12.71 16.71C12.52 16.89 12.26 17 12 17Z" }),
        React__default['default'].createElement("path", { d: "M16 17C15.74 17 15.48 16.89 15.29 16.71C15.11 16.52 15 16.27 15 16C15 15.73 15.11 15.48 15.29 15.29C15.67 14.92 16.34 14.92 16.71 15.29C16.75 15.34 16.79 15.39 16.83 15.45C16.87 15.5 16.9 15.56 16.92 15.62C16.95 15.68 16.97 15.74 16.98 15.8C16.99 15.87 17 15.94 17 16C17 16.26 16.89 16.52 16.71 16.71C16.52 16.89 16.26 17 16 17Z" })));
};

var Icon$k = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 24 24" }, props),
        React__default['default'].createElement("path", { opacity: "0.4", d: "M17.5401 8.81014C19.1748 8.81014 20.5001 7.4849 20.5001 5.85014C20.5001 4.21537 19.1748 2.89014 17.5401 2.89014C15.9053 2.89014 14.5801 4.21537 14.5801 5.85014C14.5801 7.4849 15.9053 8.81014 17.5401 8.81014Z" }),
        React__default['default'].createElement("path", { d: "M6.46 8.81014C8.09476 8.81014 9.42 7.4849 9.42 5.85014C9.42 4.21537 8.09476 2.89014 6.46 2.89014C4.82524 2.89014 3.5 4.21537 3.5 5.85014C3.5 7.4849 4.82524 8.81014 6.46 8.81014Z" }),
        React__default['default'].createElement("path", { d: "M17.5401 21.1099C19.1748 21.1099 20.5001 19.7847 20.5001 18.1499C20.5001 16.5152 19.1748 15.1899 17.5401 15.1899C15.9053 15.1899 14.5801 16.5152 14.5801 18.1499C14.5801 19.7847 15.9053 21.1099 17.5401 21.1099Z" }),
        React__default['default'].createElement("path", { opacity: "0.4", d: "M6.46 21.1099C8.09476 21.1099 9.42 19.7847 9.42 18.1499C9.42 16.5152 8.09476 15.1899 6.46 15.1899C4.82524 15.1899 3.5 16.5152 3.5 18.1499C3.5 19.7847 4.82524 21.1099 6.46 21.1099Z" })));
};
...
var templateObject_1$19, templateObject_2$w, templateObject_3$e, templateObject_4$b;
...
var templateObject_1$16, templateObject_2$v, templateObject_3$d, templateObject_4$a;
...
var ButtonMenuItem = function (_a) {
    ...
    if (!isActive) {
        return React__default['default'].createElement(InactiveButton$1, __assign({ forwardedAs: as, variant: variant }, props));
    }
...
var getBackgroundColor = function (_a) {
    var theme = _a.theme, variant = _a.variant;
    return theme.colors[variant === variants$6.SUBTLE ? "bgTabs" : "bgTabs"];
};
var StyledButtonTabs = styled__default['default'].div(templateObject_1$12 || (templateObject_1$12 = __makeTemplateObject(["\n  background-color: ", ";\n  border-radius: 10px 10px 0 0;\n  display: ", ";\n  width: ", ";\n\n  & > button,\n  & > a {\n    flex: ", ";\n  }\n  & :hover {\n    /* border-radius: 10px; */\n  }\n\n  & > button + button,\n  & > a + a {\n    /* To avoid focus shadow overlap */\n    margin-left: 2px;\n  }\n\n  & > button,\n  & a {\n    box-shadow: none;\n  }\n\n  ", "\n  ", "\n"], ["\n  background-color: ", ";\n  border-radius: 10px 10px 0 0;\n  display: ", ";\n  width: ", ";\n\n  & > button,\n  & > a {\n    flex: ", ";\n  }\n  & :hover {\n    /* border-radius: 10px; */\n  }\n\n  & > button + button,\n  & > a + a {\n    /* To avoid focus shadow overlap */\n    margin-left: 2px;\n  }\n\n  & > button,\n  & a {\n    box-shadow: none;\n  }\n\n  ",
    ...
    var disabled = _a.disabled, theme = _a.theme, variant = _a.variant;
    if (disabled) {
        return "\n        opacity: 0.5;\n\n        & > button:disabled {\n          background-color: transparent;\n          color: " + (variant === variants$6.PRIMARY ? theme.colors.textSubtle : theme.colors.textSubtle) + ";\n        }\n    ";
    }
    return "";
}, styledSystem.space);
var ButtonTabs = function (_a) {
    var _b = _a.activeIndex, activeIndex = _b === void 0 ? 0 : _b, _c = _a.scale, scale = _c === void 0 ? scales$8.MD : _c, _d = _a.variant, variant = _d === void 0 ? variants$6.PRIMARY : _d, onItemClick = _a.onItemClick, disabled = _a.disabled, children = _a.children, _e = _a.fullWidth, fullWidth = _e === void 0 ? false : _e, props = __rest(_a, ["activeIndex", "scale", "variant", "onItemClick", "disabled", "children", "fullWidth"]);
    return (React__default['default'].createElement(StyledButtonTabs, __assign({ disabled: disabled, variant: variant, fullWidth: fullWidth }, props), React.Children.map(children, function (child, index) {
        return React.cloneElement(child, {
            isActive: activeIndex === index,
            onClick: onItemClick ? function () { return onItemClick(index); } : undefined,
            scale: scale,
...
var InactiveButton = styled__default['default'](Button)(templateObject_1$11 || (templateObject_1$11 = __makeTemplateObject(["\n  background-color: transparent;\n  padding: 0 8px !important;\n  display: flex;\n  justify-content: center;\n  flex-direction: column;\n  border-radius: 0;\n  color: ", ";\n  &:hover:not(:disabled):not(:active) {\n    background-color: transparent;\n  }\n"], ["\n  background-color: transparent;\n  padding: 0 8px !important;\n  display: flex;\n  justify-content: center;\n  flex-direction: column;\n  border-radius: 0;\n  color: ", ";\n  &:hover:not(:disabled):not(:active) {\n    background-color: transparent;\n  }\n"])), function (_a) {
    var theme = _a.theme, variant = _a.variant;
    return (variant === variants$6.PRIMARY ? theme.colors.textDimmed : theme.colors.textSubtle);
});
var BtnTabs = styled__default['default'](Button)(templateObject_2$t || (templateObject_2$t = __makeTemplateObject(["\n  border-radius: 10px 10px 0 0 !important;\n  display: flex;\n  justify-content: center;\n  padding: 0 8px !important;\n  flex-direction: column;\n  background-color: ", ";\n  border-bottom: ", " 3px solid;\n  color: ", ";\n"], ["\n  border-radius: 10px 10px 0 0 !important;\n  display: flex;\n  justify-content: center;\n  padding: 0 8px !important;\n  flex-direction: column;\n  background-color: ", ";\n  border-bottom: ", " 3px solid;\n  color: ", ";\n"])), function (_a) {
    var theme = _a.theme;
...
var ButtonTabsItem = function (_a) {
    var _b = _a.isActive, isActive = _b === void 0 ? false : _b, _c = _a.variant, variant = _c === void 0 ? variants$6.PRIMARY : _c, icons = _a.icons, as = _a.as, props = __rest(_a, ["isActive", "variant", "icons", "as"]);
    // console.log(props);
    if (!isActive) {
        return (React__default['default'].createElement(InactiveButton, __assign({ forwardedAs: as, variant: variant }, props), props === null || props === void 0 ? void 0 :
            props.children,
    ...
    return (React__default['default'].createElement(BtnTabs, __assign({ forwardedAs: as, variant: variant }, props), props === null || props === void 0 ? void 0 :
        props.children,
        React.isValidElement(icons) &&
            React.cloneElement(icons, {
                mt: "0.25rem",
...
var templateObject_1$11, templateObject_2$t;
...
var templateObject_1$10, templateObject_2$s, templateObject_3$c, templateObject_4$9;
...
var StyledWrapper = styled__default['default'].div(templateObject_1$T || (templateObject_1$T = __makeTemplateObject(["\n  max-height: ", "px;\n  max-width: ", "px;\n  position: relative;\n  width: 100%;\n\n  &:after {\n    content: \"\";\n    display: block;\n    padding-top: ", "%;\n  }\n\n  ", "\n"], ["\n  max-height: ", "px;\n  max-width: ", "px;\n  position: relative;\n  width: 100%;\n\n  &:after {\n    content: \"\";\n    display: block;\n    padding-top: ", "%;\n  }\n\n  ", "\n"])), function (_a) {
...
var Placeholder = styled__default['default'].div(templateObject_1$S || (templateObject_1$S = __makeTemplateObject(["\n  height: 100%;\n  left: 0;\n  position: absolute;\n  top: 0;\n  width: 100%;\n"], ["\n  height: 100%;\n  left: 0;\n  position: absolute;\n  top: 0;\n  width: 100%;\n"])));
var templateObject_1$S;

var StyledBackgroundImage = styled__default['default'](Wrapper$3)(templateObject_1$R || (templateObject_1$R = __makeTemplateObject(["\n  background-repeat: no-repeat;\n  background-size: contain;\n"], ["\n  background-repeat: no-repeat;\n  background-size: contain;\n"])));
...
var TokenImage = styled__default['default'](Image)(templateObject_1$P || (templateObject_1$P = __makeTemplateObject(["\n  &:before {\n    border-radius: 50%;\n    border: 1px solid rgba(0, 0, 0, 0.25);\n    content: \"\";\n    height: 100%;\n    left: 0;\n    position: absolute;\n    top: 0;\n    width: 100%;\n    z-index: 7;\n  }\n"], ["\n  &:before {\n    border-radius: 50%;\n    border: 1px solid rgba(0, 0, 0, 0.25);\n    content: \"\";\n    height: 100%;\n    left: 0;\n    position: absolute;\n    top: 0;\n    width: 100%;\n    z-index: 7;\n  }\n"])));
...
var _a$3, _b$2;
var StyledPrimaryImage = styled__default['default'](TokenImage)(templateObject_1$O || (templateObject_1$O = __makeTemplateObject(["\n  position: absolute;\n  width: 90%;\n  height: 90%;\n\n  ", "\n"], ["\n  position: absolute;\n  width: 90%;\n  height: 90%;\n\n  ",
    "\n"])), styledSystem.variant({
    variants: (_a$3 = {},
...
var StyledProfileAvatar = styled__default['default'](BackgroundImage)(templateObject_1$N || (templateObject_1$N = __makeTemplateObject(["\n  border-radius: 50%;\n"], ["\n  border-radius: 50%;\n"])));
...
var StyledInputGroup = styled__default['default'](Box)(templateObject_1$M || (templateObject_1$M = __makeTemplateObject(["\n  ", " {\n    padding-left: ", ";\n    padding-right: ", ";\n  }\n"], ["\n  ", " {\n    padding-left: ", ";\n    padding-right: ", ";\n  }\n"])), Input$1, function (_a) {
...
var StyledLink$2 = styled__default['default'](Text)(templateObject_1$J || (templateObject_1$J = __makeTemplateObject(["\n  display: flex;\n  align-items: center;\n  width: fit-content;\n  &:hover {\n    text-decoration: underline;\n  }\n"], ["\n  display: flex;\n  align-items: center;\n  width: fit-content;\n  &:hover {\n    text-decoration: underline;\n  }\n"])));
var Link = function (_a) {
    var external = _a.external, props = __rest(_a, ["external"]);
    var internalProps = external ? getExternalLinkProps() : {};
    return React__default['default'].createElement(StyledLink$2, __assign({ as: "a" }, internalProps, props));
};
Link.defaultProps = {
    color: "primary",
};
...
var templateObject_1$F, templateObject_2$l, templateObject_3$b;
...
var templateObject_1$B, templateObject_2$j, templateObject_3$a, templateObject_4$8, templateObject_5$4, templateObject_6$2, templateObject_7$1;
...
var templateObject_1$A, templateObject_2$i, templateObject_3$9, templateObject_4$7, templateObject_5$3;
...
var SpinnerGif = "aab262fd24c4012b.gif";
...
styled__default['default'](Icon$i)(templateObject_4$6 || (templateObject_4$6 = __makeTemplateObject(["\n  position: absolute;\n  top: 0;\n  left: 0;\n  animation: ", " 2s linear infinite;\n  transform: translate3d(0, 0, 0);\n"], ["\n  position: absolute;\n  top: 0;\n  left: 0;\n  animation: ", " 2s linear infinite;\n  transform: translate3d(0, 0, 0);\n"])), rotate);
styled__default['default'](Icon$j)(templateObject_5$2 || (templateObject_5$2 = __makeTemplateObject(["\n  animation: ", " 6s ease-in-out infinite;\n  transform: translate3d(0, 0, 0);\n"], ["\n  animation: ", " 6s ease-in-out infinite;\n  transform: translate3d(0, 0, 0);\n"])), float);
var Content = styled__default['default'].div(templateObject_6$1 || (templateObject_6$1 = __makeTemplateObject(["\n  /* border: 1px solid #000; */\n  background-image: url(", ");\n  background-size: cover;\n  width: ", ";\n  height: ", ";\n"], ["\n  /* border: 1px solid #000; */\n  background-image: url(", ");\n  background-size: cover;\n  width: ", ";\n  height: ", ";\n"])), SpinnerGif, function (_a) {
    var width = _a.width;
    return width;
}, function (_a) {
    var width = _a.width;
...
var Spinner = function (_a) {
    ...
    return (React__default['default'].createElement(Container$3, null,
        React__default['default'].createElement(Content, { width: size + "px" })));
};
var templateObject_1$z, templateObject_2$h, templateObject_3$8, templateObject_4$6, templateObject_5$2, templateObject_6$1;
...
var templateObject_1$x, templateObject_2$g, templateObject_3$7, templateObject_4$5, templateObject_5$1, templateObject_6, templateObject_7;

var SubMenuContainer = styled__default['default'].div(templateObject_1$w || (templateObject_1$w = __makeTemplateObject(["\n  display: flex;\n  flex-direction: column;\n  overflow: hidden;\n  min-width: 136px;\n  background: ", ";\n  border-radius: ", ";\n  border: ", ";\n"], ["\n  display: flex;\n  flex-direction: column;\n  overflow: hidden;\n  min-width: 136px;\n  background: ", ";\n  border-radius: ", ";\n  border: ", ";\n"])), function (_a) {
    var theme = _a.theme;
    return theme.colors.input;
}, function (_a) {
    var theme = _a.theme;
...
var templateObject_1$w, templateObject_2$f, templateObject_3$6;
...
var Td = styled__default['default'].td(templateObject_1$v || (templateObject_1$v = __makeTemplateObject(["\n  border-bottom: 1px solid ", ";\n  color: ", ";\n  padding: 16px;\n  vertical-align: middle;\n\n  ", "\n"], ["\n  border-bottom: 1px solid ", ";\n  color: ", ";\n  padding: 16px;\n  vertical-align: middle;\n\n  ", "\n"])), function (_a) {
    var theme = _a.theme;
    return theme.colors.cardBorder;
}, function (_a) {
    var theme = _a.theme;
...
var Table = styled__default['default'].table(templateObject_1$u || (templateObject_1$u = __makeTemplateObject(["\n  max-width: 100%;\n  width: 100%;\n\n  tbody tr:last-child {\n    ", " {\n      border-bottom: 0;\n    }\n  }\n\n  ", "\n"], ["\n  max-width: 100%;\n  width: 100%;\n\n  tbody tr:last-child {\n    ", " {\n      border-bottom: 0;\n    }\n  }\n\n  ", "\n"])), Td, styledSystem.space);
var templateObject_1$u;
...
var Wrapper$1 = styled__default['default'](Flex)(templateObject_1$t || (templateObject_1$t = __makeTemplateObject(["\n  border-bottom: 2px solid ", ";\n  overflow-x: scroll;\n\n  ::-webkit-scrollbar {\n    display: none;\n  }\n  -ms-overflow-style: none; /* IE and Edge */\n  scrollbar-width: none; /* Firefox */\n"], ["\n  border-bottom: 2px solid ", ";\n  overflow-x: scroll;\n\n  ::-webkit-scrollbar {\n    display: none;\n  }\n  -ms-overflow-style: none; /* IE and Edge */\n  scrollbar-width: none; /* Firefox */\n"])), function (_a) {
    var theme = _a.theme;
    return theme.colors.textSubtle;
});
...
var getBorderRadius = function (_a) {
    var scale = _a.scale;
    return (scale === "md" ? "10px 10px 0 0" : "24px 24px 0 0");
};
...
var StyledToggle = styled__default['default'].div(templateObject_3$5 || (templateObject_3$5 = __makeTemplateObject(["\n  align-items: center;\n  background: ", ";\n  border-radius: 24px;\n  /* box-shadow: ", "; */\n  cursor: pointer;\n  display: inline-flex;\n  height: ", ";\n  position: relative;\n  transition: background-color 200ms;\n  width: ", ";\n"], ["\n  align-items: center;\n  background: ", ";\n  border-radius: 24px;\n  /* box-shadow: ", "; */\n  cursor: pointer;\n  display: inline-flex;\n  height: ", ";\n  position: relative;\n  transition: background-color 200ms;\n  width: ", ";\n"])), function (_a) {
    var theme = _a.theme;
    return theme.colors.gradients.toggle;
}, function (_a) {
    var theme = _a.theme;
    return theme.shadows.inset;
}, getScale("toggleHeight"), getScale("toggleWidth"));
var templateObject_1$q, templateObject_2$c, templateObject_3$5;
...
var lightColors = __assign(__assign(__assign({}, baseColors), additionalColors), { background: "#FFFFFF", backgroundDisabled: "#F5F1EB", backgroundAlt: "#FAF8F5", cardBorder: "#E7E3EB", contrast: "#191326", dropdown: "#F6F6F6", dropdownDeep: "#EEEEEE", invertedContrast: "#FFFFFF", input: "#F5F1EB", inputSecondary: "#d7caec", tertiary: "#EFF4F5", text: "#464754", textDisabled: "#BDC2C4", textSubtle: "#807373", disabled: "#E9EAEB", gradients: {
    ...
    // added background
    bgLight: "#F2F3F5", bgDark: "#FAF8F5", bgDarker: "#F5F1EB", bgWrapper: "#F2F3F5", bgTabs: "#FAF8F5", 
    // added text
    textNormal: "#464754", textLight: "#807373", textDimmed: "#A69F9F" });
var darkColors = __assign(__assign(__assign({}, baseColors), additionalColors), { secondary: "#827C75", background: "#202226", backgroundDisabled: "#3c3742", backgroundAlt: "#27262c", cardBorder: "#383241", contrast: "#FFFFFF", dropdown: "#1E1D20", dropdownDeep: "#100C18", invertedContrast: "#191326", input: "#2E2C28", inputSecondary: "#262130", primaryDark: "#0098A1", tertiary: "#353547", text: "#EEF1F8", textDisabled: "#666171", textSubtle: "#827C75", disabled: "#524B63", gradients: {
        ...
        roburna: " linear-gradient(93.1deg, #00783F -14.09%, #C89211 123.87%);",
    }, bgLight: "#2E2C28", bgDark: "#202226", bgDarker: "#17181A", bgWrapper: "#17181A", bgTabs: "#242322", 
    // added text
    textNormal: "#464754", textLight: "#807373", textDimmed: "#807373" });
...
var ModalHeader = styled__default['default'].div(templateObject_1$o || (templateObject_1$o = __makeTemplateObject(["\n  align-items: center;\n  background: ", ";\n  border-bottom: 1px solid ", ";\n  display: flex;\n  padding: 12px 24px;\n"], ["\n  align-items: center;\n  background: ", ";\n  border-bottom: 1px solid ", ";\n  display: flex;\n  padding: 12px 24px;\n"])), function (_a) {
...
var ModalCloseButton = function (_a) {
    ...
    return (React__default['default'].createElement(IconButton, { variant: "text", onClick: onDismiss, "aria-label": "Close the dialog" },
        React__default['default'].createElement(Icon$1z, { color: "#E56060" })));
};
...
var templateObject_1$o, templateObject_2$a, templateObject_3$4, templateObject_4$4;
...
var Icon$h = function (props) {
    ...
    React__default['default'].createElement("path", { "fill-rule": "evenodd", "clip-rule": "evenodd", d:"M8.3 11.7v-.925c0-.358-.267-.533-.592-.391l-4.175 1.8c-.658.283-1.191-.067-1.191-.775v-1.1c0-.567.425-1.225.95-1.442l4.75-2.042a.487.487 0 0 0 .25-.391v-2.55c0-.8.591-1.759 1.3-2.125a.9.9 0 0 1 .8 0c.716.366 1.308 1.316 1.308 2.116v2.55c0 .15.117.325.25.392l.867.367L8.3 11.7Z" }),
    React__default['default'].createElement("path", { "fill-rule": "evenodd", "clip-rule": "evenodd", d:"M17.659 10.309v1.1c0 .708-.534 1.058-1.192.775l-4.175-1.8c-.333-.134-.592.033-.592.391V13.2c0 .192.109.467.25.6l1.934 1.942c.2.2.291.6.2.875l-.375 1.133a.852.852 0 0 1-1.184.492l-1.983-1.667a.866.866 0 0 0-1.092 0l-1.983 1.667A.826.826 0 0 1 6.3 17.75l-.375-1.133c-.091-.283 0-.675.2-.875L8.06 13.8a.986.986 0 0 0 .241-.6v-1.5l4.517-4.516 3.892 1.675c.525.225.95.883.95 1.45Z" }),
...
var Logo$2 = function (_a) {
    var props = __rest(_a, []);
    return (React__default['default'].createElement(Svg, __assign({ width: "188", height: "39", viewBox: "0 0 188 39", fill: "none", xmlns: "http://www.w3.org/2000/svg" }, props),
        React__default['default'].createElement("path", { d: "M14.687 1.12598C14.687 1.12598 -0.218715 4.2598 1.03481 20.9774C2.28834 37.695 23.0458 42.5705 32.7264 32.5403C32.7264 32.5403 15.9405 41.2467 7.23412 28.2213C-1.47224 15.196 7.65196 3.56274 14.687 1.12598Z", fill: "#6BA43A" }),
        React__default['default'].createElement("path", { d: "M31.553 3.58228C39.7517 9.33835 41.3195 21.243 35.1671 29.0902C29.1494 37.039 17.2311 38.5561 9.58105 32.0913C17.3209 37.7536 28.6964 36.2443 34.4759 28.5572C40.4409 20.952 39.0097 9.67029 31.553 3.58228Z", fill: "#C89211" }),
        React__default['default'].createElement("path", { d: "M2.26097 23.4981C-0.34176 15.6567 3.63946 6.42314 10.7662 2.39896C13.1229 1.03219 15.7803 0.204311 18.4397 0.0891113C15.917 0.922845 13.5779 2.05922 11.5121 3.55486C5.15463 8.0496 1.79236 15.7504 2.26097 23.4981Z", fill: "#4A8B2C" }),
        React__default['default'].createElement("path", { d: "
z", fill: "#00783F" }),
        React__default['default'].createElement("path", { d: "M54.5774 13.9755L50.4361 23.9218C49.7351 25.6068 48.0872 26.7061 46.2616 26.7061C45.791 26.7061 45.4786 26.2179 45.6758 25.7903L54.7141 6.26106C55.0655 5.50348 56.1414 5.49958 56.4987 6.25521L67.4798 29.5587C67.6633 29.9473 67.3802 30.3944 66.9506 30.3944H66.7827C64.9825 30.3944 63.356 29.3283 62.6375 27.6784L56.6647 13.9599C56.2644 13.0422 54.9621 13.052 54.5774 13.9755Z", fill: "#BF9000" }),
        React__default['default'].createElement("path", { d: "M74.7414 16.2676C74.4388 16.0255 74.1557 15.8439 73.894 15.7229C73.6324 15.6018 73.2985 15.5413 72.8963 15.5413C72.0899 15.5413 71.5041 15.8498 71.1409 16.4649C70.7778 17.0799 70.5962 17.8824 70.5962 18.8704V26.7059H67.3589V12.7882H70.5962V14.4518C71.0199 13.8465 71.508 13.3623 72.0645 12.9991C72.619 12.6359 73.1892 12.4543 73.773 12.4543C74.2767 12.4543 74.7512 12.5403 75.1944 12.7121C75.6376 12.8839 76.0203 13.1514 76.3445 13.5146L74.7414 16.2676Z", fill: "#BF9000" }),
        React__default['default'].createElement("path", { d: "M91.8515 19.7472C91.8515 21.2799 91.5391 22.5862 90.9143 23.6659C90.2895 24.7457 89.4616 25.5716 88.4326 26.1476C87.4036 26.7216 86.2848 27.0106 85.0742 27.0106C84.0452 27.0106 83.1276 26.7841 82.3212 26.3292C81.5148 25.8762 80.8489 25.224 80.3237 24.3786V26.708H77.0259V3.10767H80.3237V15.1177C80.847 14.2703 81.5128 13.6201 82.3212 13.1671C83.1276 12.7141 84.0452 12.4857 85.0742 12.4857C86.2848 12.4857 87.4036 12.7727 88.4326 13.3487C89.4616 13.9228 90.2875 14.7506 90.9143 15.8304C91.5391 16.9082 91.8515 18.2144 91.8515 19.7472ZM88.4619 19.7472C88.4619 18.355 88.0479 17.2714 87.222 16.4943C86.3942 15.7171 85.4159 15.3305 84.2874 15.3305C83.6411 15.3305 83.0163 15.5024 82.411 15.8441C81.8057 16.1877 81.3058 16.6856 80.9134 17.3417C80.5209 17.9977 80.3237 18.7983 80.3237 19.7472C80.3237 20.6961 80.5209 21.4967 80.9134 22.1527C81.3058 22.8088 81.8057 23.3086 82.411 23.6503C83.0163 23.994 83.6411 24.1638 84.2874 24.1638C85.4159 24.1638 86.3942 23.7753 87.222 22.9982C88.0499 22.223 88.4619 21.1374 88.4619 19.7472Z", fill: "#BF9000" }),
        React__default['default'].createElement("path", { d: "M93.1421 19.7471C93.1421 18.3159 93.4701 17.0545 94.1262 15.965C94.7822 14.8755 95.6745 14.0242 96.8031 13.4091C97.9317 12.7941 99.2125 12.4856 100.646 12.4856C102.057 12.4856 103.332 12.7941 104.473 13.4091C105.611 14.0242 106.509 14.8775 107.165 15.965C107.821 17.0545 108.149 18.3159 108.149 19.7471C108.149 21.1802 107.821 22.4396 107.165 23.5291C106.509 24.6187 105.611 25.47 104.473 26.085C103.332 26.7001 102.057 27.0086 100.646 27.0086C99.2125
14.4937 4.01674 14.5272 4.78661C14.5607 5.62343 14.5607 5.89121 14.5607 8.03347C14.5607 10.1757 14.5607 10.41 14.5272 11.2803C14.4937 12.0502 14.3598 12.4854 14.2594 12.7531C13.9916 13.4561 13.4226 13.9916 12.7531 14.2594C12.4854 14.3598 12.0502 14.4937 11.2803 14.5272C10.41 14.5941 10.1423 14.5941 8.03347 14.5941Z" }),
        React__default['default'].createElement("path", { d: "M7.99997 3.88232C5.72382 3.88232 3.88281 5.72336 3.88281 7.99956C3.88281 10.2757 5.72382 12.1168 7.99997 12.1168C10.2761 12.1168 12.1171 10.2757 12.1171 7.99956C12.1171 5.75684 10.2761 3.88232 7.99997 3.88232ZM7.99997 10.6774C6.52717 10.6774 5.32214 9.47239 5.32214 7.99956C5.32214 6.52672 6.52717 5.32168 7.99997 5.32168C9.47278 5.32168 10.6778 6.52672 10.6778 7.99956C10.6778 9.50586 9.50625 10.6774 7.99997 10.6774Z" }),
        React__default['default'].createElement("path", { d: "M13.2549 3.74989C13.2549 3.21412 12.8198 2.77881 12.2842 2.77881C11.7486 2.77881 11.3135 3.21412 11.3135 3.74989C11.3135 4.28566 11.7486 4.72097 12.2842 4.72097C12.8198 4.68748 13.2549 4.25217 13.2549 3.74989Z" })));
};
...
var StyledFlex$1 = styled__default['default'](Flex)(templateObject_1$l || (templateObject_1$l = __makeTemplateObject(["\n  ", " {\n    display: none;\n  }\n"], ["\n  ", " {\n    display: none;\n  }\n"])), function (_a) {
    var theme = _a.theme;
    return theme.mediaQueries.nav;
});
var HamburgButton = function (_a) {
    var isPushed = _a.isPushed, togglePush = _a.togglePush;
    return (React__default['default'].createElement(StyledFlex$1, null,
...
var HamburgButton$1 = React__default['default'].memo(HamburgButton, function (prev, next) { return prev.isPushed === next.isPushed; });
var templateObject_1$l;

var MenuButtonFixed = styled__default['default'](Button)(templateObject_1$k || (templateObject_1$k = __makeTemplateObject(["\n  color: ", ";\n  padding: 8px;\n  width: 48px;\n  height: 48px;\n  border-radius: 50%;\n"], ["\n  color: ", ";\n  padding: 8px;\n  width: 48px;\n  height: 48px;\n  border-radius: 50%;\n"])), function (_a) {
    var theme = _a.theme;
    return theme.colors.primary;
});
...
var StyledFlex = styled__default['default'](Flex)(templateObject_1$j || (templateObject_1$j = __makeTemplateObject(["\n  display: none;\n  position: absolute;\n  left: -30px;\n  top: 70px;\n  ", " {\n    display: block;\n  }\n"], ["\n  display: none;\n  position: absolute;\n  left: -30px;\n  top: 70px;\n  ", " {\n    display: block;\n  }\n"])), function (_a) {
    var theme = _a.theme;
    return theme.mediaQueries.nav;
});
var HamburgButtonFixed = function (_a) {
    var showMenu = _a.showMenu, togglePush = _a.togglePush;
    return (React__default['default'].createElement(StyledFlex, { showMenu: showMenu },
        React__default['default'].createElement(MenuButtonFixed, { "aria-label": "Toggle menu", onClick: togglePush, mr: "24px" },
            React__default['default'].createElement(Icon$o, { width: "24px", color: "primary" }))));
};
var HamburgButtonFixed$1 = React__default['default'].memo(HamburgButtonFixed, function (prev, next) { return prev.isPushed === next.isPushed; });
var templateObject_1$j;
...
var MenuEntry = styled__default['default'].div(templateObject_3$3 || (templateObject_3$3 = __makeTemplateObject(["\n  cursor: pointer;\n\n  display: flex;\n  align-items: center;\n  height: ", "px;\n  padding: ", ";\n  font-size: ", ";\n  background-color: ", ";\n  color: ", ";\n  a {\n    display: flex;\n    align-items: center;\n    width: 100%;\n    height: 100%;\n  }\n\n  svg {\n    fill: ", ";\n  }\n\n  &:hover {\n    color: ", ";\n    svg {\n      fill: ", ";\n    }\n  }\n\n  // Safari fix\n  flex-shrink: 0;\n\n  &.rainbow {\n    background-clip: text;\n    animation: ", " 3s ease-in-out infinite;\n    background: ", ";\n    background-size: 400% 100%;\n  }\n"], ["\n  cursor: pointer;\n\n  display: flex;\n  align-items: center;\n  height: ", "px;\n  padding: ", ";\n  font-size: ", ";\n  background-color: ", ";\n  color: ", ";\n  a {\n    display: flex;\n    align-items: center;\n    width: 100%;\n    height: 100%;\n  }\n\n  svg {\n    fill: ", ";\n  }\n\n  &:hover {\n    color: ", ";\n    svg {\n      fill: ", ";\n    }\n  }\n\n  // Safari fix\n  flex-shrink: 0;\n\n  &.rainbow {\n    background-clip: text;\n    animation: ", " 3s ease-in-out infinite;\n    background: ", ";\n    background-size: 400% 100%;\n  }\n"])), MENU_ENTRY_HEIGHT, function (_a) {
    ...
    return (secondary ? "0 16px 0 64px" : "0 16px 0 32px");
}, function (_a) {
    var secondary = _a.secondary;
    return (secondary ? "16px" : "16px");
}, function (_a) {
    var secondary = _a.secondary, theme = _a.theme;
    return (secondary ? theme.colors.backgroundAlt : "transparent");
}, function (_a) {
    var isActive = _a.isActive, theme = _a.theme;
    return (isActive ? theme.colors.primary : theme.colors.textDimmed);
}, function (_a) {
    var isActive = _a.isActive, theme = _a.theme;
    return (isActive ? theme.colors.primary : theme.colors.textDimmed);
}, function (_a) {
...
var templateObject_1$i, templateObject_2$9, templateObject_3$3, templateObject_4$3;
...
var Accordion = function (_a) {
    ...
    return (React__default['default'].createElement(Container$2, null,
        React__default['default'].createElement(MenuEntry, { onClick: handleClick, className: className, isActive: isActive, role: "button" },
            ...
            status && (React__default['default'].createElement(LinkStatus, { color: status.color, isPushed: isPushed, fontSize: "14px" }, status.text)),
...
var StyledLink$1 = styled__default['default'](reactRouterDom.Link)(templateObject_2$7 || (templateObject_2$7 = __makeTemplateObject(["\n  padding-top: 20px;\n  display: flex;\n  align-items: center;\n  .mobile-icon {\n    width: 32px;\n  }\n  .desktop-icon {\n    margin: 0 auto;\n    width: 160px;\n  }\n  .right-eye {\n    animation-delay: 20ms;\n  }\n  &:hover {\n    .left-eye,\n    .right-eye {\n      transform-origin: center 60%;\n      animation-name: ", ";\n      animation-duration: 350ms;\n      animation-iteration-count: 1;\n    }\n  }\n"], ["\n  padding-top: 20px;\n  display: flex;\n  align-items: center;\n  .mobile-icon {\n    width: 32px;\n  }\n  .desktop-icon {\n    margin: 0 auto;\n    width: 160px;\n  }\n  .right-eye {\n    animation-delay: 20ms;\n  }\n  &:hover {\n    .left-eye,\n    .right-eye {\n      transform-origin: center 60%;\n      animation-name: ", ";\n      animation-duration: 350ms;\n      animation-iteration-count: 1;\n    }\n  }\n"])), blink);
var Logo = function (_a) {
    var isPushed = _a.isPushed, href = _a.href;
    var isAbsoluteUrl = href.startsWith("http");
    // console.log("isPushed :", isPushed);
    // console.log("isAbsoluteUrl :", isAbsoluteUrl);
    return (React__default['default'].createElement(Flex, null, isAbsoluteUrl ? (React__default['default'].createElement(StyledLink$1, { as: "a", href: href, "aria-label": "Arborswap home page" }, isPushed ? React__default['default'].createElement(LogoWithText, { className: "desktop-icon" }) : React__default['default'].createElement(Icon$1j, { className: "mobile-icon" }))) : (React__default['default'].createElement(StyledLink$1, { to: href, "aria-label": "Arborswap home page" }, isPushed ? React__default['default'].createElement(LogoWithText, { className: "desktop-icon" }) : React__default['default'].createElement(Icon$1j, { className: "mobile-icon" })))));
};
var Logo$1 = React__default['default'].memo(Logo, function (prev, next) { return prev.isPushed === next.isPushed; });
...
var ContainerLogo = styled__default['default'].div(templateObject_2$6 || (templateObject_2$6 = __makeTemplateObject(["\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  overflow-y: auto;\n  overflow-x: hidden;\n  height: 150px;\n"], ["\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  overflow-y: auto;\n  overflow-x: hidden;\n  height: 150px;\n"])));
var PanelBody = function (_a) {
    ...
    return (React__default['default'].createElement(React__default['default'].Fragment, null,
        React__default['default'].createElement(ContainerLogo, null,
            React__default['default'].createElement(Logo$1, { isPushed: isPushed, href: (_b = homeLink === null || homeLink === void 0 ? void 0 : homeLink.href) !== null && _b !== void 0 ? _b : "/" })),
        React__default['default'].createElement(Container$1, null, links.map(function (entry) {
                ...
                return (React__default['default'].createElement(Accordion, { key: entry.label, isPushed: isPushed, pushNav: pushNav, icon: iconElement, label: entry.label, status: entry.status, initialOpenState: initialOpenState, className: calloutClass, isActive: entry.items.some(function (item) { return item.href === location.pathname; }) }, isPushed &&
                    entry.items.map(function (item) { return (React__default['default'].createElement(MenuEntry, { key: item.href, secondary: true, isActive: item.href === location.pathname, onClick: handleClick, isPushed: isPushed },
                        React__default['default'].createElement(MenuLink, { href: item.href },
                            React__default['default'].createElement(LinkLabelMemo, { isActive: item.href === location.pathname, isPushed: isPushed }, item.label),
                            item.status && (React__default['default'].createElement(LinkStatus, { isPushed: isPushed, color: item.status.color, fontSize: "14px" }, item.status.text))))); })));
            }
            return (React__default['default'].createElement(MenuEntry, { key: entry.label, isActive: entry.href === location.pathname, className: calloutClass },
                React__default['default'].createElement(MenuLink, { href: entry.href, onClick: handleClick },
                    ...
                    entry.status && (React__default['default'].createElement(LinkStatus, { isPushed: isPushed, color: entry.status.color, fontSize: "14px" }, entry.status.text)))));
        }))));
};
var templateObject_1$f, templateObject_2$6;

var PriceLink = styled__default['default'].div(templateObject_1$e || (templateObject_1$e = __makeTemplateObject(["\n  display: flex;\n  align-items: center;\n  border-radius: 14px;\n  background: ", ";\n  color: \"#FFFFFF\";\n  padding: 0px 8px;\n  svg {\n    transition: transform 0.3s;\n  }\n  :hover {\n    svg {\n      transform: scale(1.1);\n    }\n  }\n"], ["\n  display: flex;\n  align-items: center;\n  border-radius: 14px;\n  background: ", ";\n  color: \"#FFFFFF\";\n  padding: 0px 8px;\n  svg {\n    transition: transform 0.3s;\n  }\n  :hover {\n    svg {\n      transform: scale(1.1);\n    }\n  }\n"])), function (_a) {
    var theme = _a.theme;
    return theme.colors.roburna;
});
var CakePrice = function (_a) {
    var cakePriceUsd = _a.cakePriceUsd;
    return cakePriceUsd ? (React__default['default'].createElement(PriceLink, null,
        React__default['default'].createElement(Icon$1i, { width: "18px", height: "32px", mr: "8px" }),
        React__default['default'].createElement(Text, { color: "#FFFFFF", bold: true }, "$" + cakePriceUsd.toFixed(4)))) : (React__default['default'].createElement(Skeleton, { width: 80, height: 24 }));
};
...
var SwitcherButton = styled__default['default'](Button)(templateObject_1$d || (templateObject_1$d = __makeTemplateObject(["\n  color: ", ";\n  padding: 0 8px;\n  border-radius: 8px;\n"], ["\n  color: ", ";\n  padding: 0 8px;\n  border-radius: 8px;\n"])), function (_a) {
    var theme = _a.theme;
    return theme.colors.text;
});
var ThemeSwitcher = function (_a) {
    ...
    return (React__default['default'].createElement(Flex, { alignItems: "center" },
        React__default['default'].createElement(SwitcherButton, { size: "sm", variant: "text", onClick: function () { return toggleTheme(!isDark); } },
            React__default['default'].createElement(Flex, { alignItems: "center" }, isDark ? React__default['default'].createElement(MoonIcon, { color: "#FFFFFF" }) : React__default['default'].createElement(SunIcon, { color: "#FFC12D" }))),
        React__default['default'].createElement(Toggle, { scale: "md", checked: isDark, onChange: function () { return toggleTheme(!isDark); } })));
};
var ThemeSwitcher$1 = React__default['default'].memo(ThemeSwitcher, function (prev, next) { return prev.isDark === next.isDark; });
var templateObject_1$d;

var Icons = IconModule;
var StyledLink = styled__default['default'](Link)(templateObject_1$c || (templateObject_1$c = __makeTemplateObject(["\n  padding: 7px;\n  border-radius: 6px;\n  background-color: ", ";\n"], ["\n  padding: 7px;\n  border-radius: 6px;\n  background-color: ", ";\n"])), function (_a) {
    var theme = _a.theme;
    return theme.colors.bgDarker;
});
var SocialLinks = function () { return (React__default['default'].createElement(Flex, null, socials.map(function (social, index) {
    var Icon = Icons[social.icon];
    var iconProps = { width: "20px", color: "text", style: { cursor: "pointer" } };
    ...
    //   );
    // }
    return (React__default['default'].createElement(StyledLink, { external: true, key: social.label, href: social.href, "aria-label": social.label, mr: mr },
...
var CopyrightEntry = styled__default['default'].div(templateObject_4$2 || (templateObject_4$2 = __makeTemplateObject(["\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  height: ", "px;\n  padding: 0 16px;\n  font-size: 10px;\n  line-height: 120%;\n  color: ", ";\n  text-align: center;\n"], ["\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  height: ", "px;\n  padding: 0 16px;\n  font-size: 10px;\n  line-height: 120%;\n  color: ", ";\n  text-align: center;\n"])), MENU_ENTRY_HEIGHT, function (_a) {
    var theme = _a.theme;
    return theme.colors.textDimmed;
});
var PanelFooter = function (_a) {
    var isPushed = _a.isPushed; _a.pushNav; var toggleTheme = _a.toggleTheme, isDark = _a.isDark, cakePriceUsd = _a.cakePriceUsd; _a.currentLang; _a.langs; _a.setLang;
    if (!isPushed) {
    ...
    return (React__default['default'].createElement(Container, null,
        ...
        React__default['default'].createElement(CopyrightEntry, null,
            React__default['default'].createElement("span", null, "@2022 Arborswap. All right Reserved. "))));
};
...
var Panel = function (props) {
    var isPushed = props.isPushed, showMenu = props.showMenu; props.isDark;
...
var StyledNav = styled__default['default'].nav(templateObject_2$4 || (templateObject_2$4 = __makeTemplateObject(["\n  position: fixed;\n  top: 0;\n  left: auto;\n  transition: top 0.2s;\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  z-index: 10;\n  ", " {\n    margin-left: ", ";\n    max-width: ", ";\n    z-index: 20;\n    top: ", ";\n  }\n\n  padding-left: 8px;\n  background-color: ", ";\n  padding-right: 16px;\n  width: 100%;\n  height: ", "px;\n  transform: translate3d(0, 0, 0);\n"], ["\n  position: fixed;\n  top: 0;\n  left: auto;\n  transition: top 0.2s;\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  z-index: 10;\n  ", " {\n    margin-left: ", ";\n    max-width: ", ";\n    z-index: 20;\n    top: ", ";\n  }\n\n  padding-left: 8px;\n  background-color: ", ";\n  padding-right: 16px;\n  width: 100%;\n  height: ", "px;\n  transform: translate3d(0, 0, 0);\n"])), function (_a) {
    ...
    return (showMenu ? 0 : "-" + (MENU_HEIGHT + 10) + "px");
}, function (_a) {
    var theme = _a.theme;
    return theme.colors.bgWrapper;
}, MENU_HEIGHT);
...
var Menu$1 = function (_a) {
    var userMenu = _a.userMenu, globalMenu = _a.globalMenu, breadcrumbMenu = _a.breadcrumbMenu, isDark = _a.isDark, toggleTheme = _a.toggleTheme, langs = _a.langs, setLang = _a.setLang, currentLang = _a.currentLang, cakePriceUsd = _a.cakePriceUsd, links = _a.links, children = _a.children;
    var _b = useMatchBreakpoints(), isMobile = _b.isMobile, isTablet = _b.isTablet;
    var isSmallerScreen = isMobile || isTablet;
    var _c = React.useState(!isSmallerScreen), isPushed = _c[0], setIsPushed = _c[1];
        ...
        React__default['default'].createElement(BodyWrapper, null,
            React__default['default'].createElement(StyledNav, { isPushed: isPushed, showMenu: showMenu },
                React__default['default'].createElement(Flex, null,
                    React__default['default'].createElement(HamburgButton$1, { isPushed: isPushed, togglePush: function () { return setIsPushed(function (prevState) { return !prevState; }); } }),
                    React__default['default'].createElement(HamburgButtonFixed$1, { showMenu: showMenu, isPushed: isPushed, togglePush: function () { return setIsPushed(function (prevState) { return !prevState; }); } }),
                    breadcrumbMenu),
                React__default['default'].createElement(Flex, { alignItems: "center" },
                    globalMenu,
                    " ",
...
var templateObject_1$9, templateObject_2$4, templateObject_3$1, templateObject_4$1, templateObject_5;
...
var NoProfileMenuIcon = function () { return (React__default['default'].createElement(MenuIconWrapper, { borderColor: "primary" },
    React__default['default'].createElement(Icon$r, { color: "text", width: "24px" }))); };
...
var ElipsisIconDiv = styled__default['default'].div(templateObject_4 || (templateObject_4 = __makeTemplateObject(["\n  display: none;\n  ", " {\n    display: block;\n  }\n"], ["\n  display: none;\n  ", " {\n    display: block;\n  }\n"])), function (_a) {
    var theme = _a.theme;
    return theme.mediaQueries.nav;
});
var UserMenu = function (_a) {
    ...
    return (React__default['default'].createElement(React__default['default'].Fragment, null,
        React__default['default'].createElement(StyledUserMenu, __assign({ ref: setTargetRef }, props),
            ...
            React__default['default'].createElement(ElipsisIconDiv, null,
                React__default['default'].createElement(Icon$1s, { color: "primary", width: "20px", marginLeft: "10px" }))),
...
var templateObject_1$6, templateObject_2$1, templateObject_3, templateObject_4;
...
exports.ButtonTabsItem = ButtonTabsItem;
...
exports.MoreProductIcon = Icon$k;
...
exports.WalletArborIcon = Icon$r;
